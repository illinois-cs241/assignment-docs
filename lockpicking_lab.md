...
You have already been assigned a [HW0]({% link _coursebook/Background.md#homework-0 %}) for the class. Add your answers to `hw0.md` in your course repository. Remember to commit and push your answers. We'll spend the first part of class going over the various questions from HW0. Your grade for this lab is partly HW0 and partly the assignment below.
