...
Now, nobody can log in. All that's left are the hashes in the auth database. Before you can update your LoopedIn status, your manager sprints over to your desk and tells you
...
pool but before you can read the NerdsForNerds article on what a thread pool is, your manager's manager sends you a calendar invite telling you to parallelize the password cracking.
Before you can accept without response, your manager tells you to just do it both ways! It seems like a tough task but after conquering `malloc`, nothing should be too hard right?
